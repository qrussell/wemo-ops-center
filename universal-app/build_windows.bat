...
echo       Version: 5.2.4 (Robust & Syntax Fixed)
echo ========================================================
...
:: ** CRITICAL CHECK: DID MAIN APP BUILD? **
IF NOT EXIST "dist\%APP_NAME%.exe" (
    COLOR 0C
    echo.
    echo [!] ERROR: Main Dashboard failed to compile.
    echo     Check the output above for Python Syntax Errors!
    pause
    exit /b
)
...
echo.
echo [5/7] Generating Installer Config (ISS)...
...
echo OutputDir=dist
echo OutputBaseFilename=WemoOps_Setup_v5.2.4
...
if not exist "dist\%HOOBS_EXE_NAME%.exe" (
    COLOR 0C
    echo [ERROR] HOOBS Installer Missing from dist folder!
    pause
    exit /b
)
echo    - Found %HOOBS_EXE_NAME%.exe
...
echo ========================================================
echo    BUILD COMPLETE!
echo    Installer is in: dist\WemoOps_Setup_v5.2.4.exe
echo ========================================================
pause